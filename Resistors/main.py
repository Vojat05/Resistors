...
imgbck = Image.open(resource_path('bg.jpg'))
...
# Obrázek rezistoru.
image = Image.open(resource_path('normal2.png'))
...
def pruh1Draw(x):
    ...
    global img2
    if 1 == x:
        ima = Image.open(resource_path('hneda.png'))

    elif 2 == x:
        ima = Image.open(resource_path('cervena.png'))

    elif 3 == x:
        ima = Image.open(resource_path('oranzova.png'))

    elif 4 == x:
        ima = Image.open(resource_path('zluta.png'))

    elif 5 == x:
        ima = Image.open(resource_path('zelena.png'))

    elif 6 == x:
        ima = Image.open(resource_path('modra.png'))

    elif 7 == x:
        ima = Image.open(resource_path('fialova.png'))

    elif 8 == x:
        ima = Image.open(resource_path('seda.png'))

    elif 9 == x:
        ima = Image.open(resource_path('bila.png'))

    else:
        ima = Image.open(resource_path('cerna.png'))
...
def pruh2Draw(y):
    ...
    global img2y
    if 1 == y:
        imay = Image.open(resource_path('hneda.png'))

    elif 2 == y:
        imay = Image.open(resource_path('cervena.png'))

    elif 3 == y:
        imay = Image.open(resource_path('oranzova.png'))

    elif 4 == y:
        imay = Image.open(resource_path('zluta.png'))

    elif 5 == y:
        imay = Image.open(resource_path('zelena.png'))

    elif 6 == y:
        imay = Image.open(resource_path('modra.png'))

    elif 7 == y:
        imay = Image.open(resource_path('fialova.png'))

    elif 8 == y:
        imay = Image.open(resource_path('seda.png'))

    elif 9 == y:
        imay = Image.open(resource_path('bila.png'))

    else:
        imay = Image.open(resource_path('cerna.png'))
...
def pruh3Draw(z):
    ...
    global img2z
    if 1 == z:
        imaz = Image.open(resource_path('hneda.png'))

    elif 2 == z:
        imaz = Image.open(resource_path('cervena.png'))

    elif 3 == z:
        imaz = Image.open(resource_path('oranzova.png'))

    elif 4 == z:
        imaz = Image.open(resource_path('zluta.png'))

    elif 5 == z:
        imaz = Image.open(resource_path('zelena.png'))

    elif 6 == z:
        imaz = Image.open(resource_path('modra.png'))

    elif 7 == z:
        imaz = Image.open(resource_path('fialova.png'))

    elif 8 == z:
        imaz = Image.open(resource_path('seda.png'))

    elif 9 == z:
        imaz = Image.open(resource_path('bila.png'))

    else:
        imaz = Image.open(resource_path('cerna.png'))
...
def pruhnDraw(n):
    ...
    global img2n
    if 1 == n:
        iman = Image.open(resource_path('hneda.png'))

    elif 2 == n:
        iman = Image.open(resource_path('cervena.png'))

    elif 3 == n:
        iman = Image.open(resource_path('oranzova.png'))

    elif 4 == n:
        iman = Image.open(resource_path('zluta.png'))

    elif 5 == n:
        iman = Image.open(resource_path('zelena.png'))

    elif 6 == n:
        iman = Image.open(resource_path('modra.png'))

    elif 7 == n:
        iman = Image.open(resource_path('fialova.png'))

    elif 8 == n:
        iman = Image.open(resource_path('zlata.png'))

    elif 9 == n:
        iman = Image.open(resource_path('stribrna.png'))

    else:
        iman = Image.open(resource_path('cerna.png'))
...
def pruhtDraw(t):
    ...
    global img2t
    if 1 == t:
        imat = Image.open(resource_path('cervena.png'))

    elif 2 == t:
        imat = Image.open(resource_path('zelena.png'))

    elif 3 == t:
        imat = Image.open(resource_path('modra.png'))

    elif 4 == t:
        imat = Image.open(resource_path('fialova.png'))

    elif 5 == t:
        imat = Image.open(resource_path('seda.png'))

    elif 6 == t:
        imat = Image.open(resource_path('zlata.png'))

    elif 7 == t:
        imat = Image.open(resource_path('stribrna.png'))

    elif 8 == t:
        imat = Image.open(resource_path('default.png'))

    else:
        imat = Image.open(resource_path('hneda.png'))
